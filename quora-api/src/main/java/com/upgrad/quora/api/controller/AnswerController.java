...
public class AnswerController {
  ...
  @Autowired CreateAnswerBusinessService createAnswerBusinessService;

  @Autowired EditAnswerBusinessService editAnswerBusinessService;

  @Autowired DeleteAnswerBusinessService deleteAnswerBusinessService;

  @Autowired GetAllAnswerBusinessService getAllAnswerBusinessService;
  ...
  public ResponseEntity<AnswerEditResponse> editAnswerContent(
    ...
    AnswerEntity updatedAnswerEntity =
        editAnswerBusinessService.editAnswerContent(answerEntity, bearerToken);
    AnswerEditResponse answerEditResponse =
        new AnswerEditResponse().id(updatedAnswerEntity.getUuid()).status("ANSWER EDITED");
  ...
  public ResponseEntity<List<AnswerDetailsResponse>> getAllAnswersToQuestion(
    ...
    List<AnswerEntity> allAnswers =
        getAllAnswerBusinessService.getAllAnswersToQuestion(questionId, bearerToken);
